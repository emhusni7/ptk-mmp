...
$ID_USER        = $_SESSION["LOGINIDUS_PERSONALIA"];
...
unset($_SESSION["PC_NAME_PERSONALIA"]);
unset($_SESSION["IP_ADDRESS_PERSONALIA"]);
unset($_SESSION["LOGINIDUS_PERSONALIA"]);
unset($_SESSION["LOGINNAMAUS_PERSONALIA"]);
unset($_SESSION["LOGINAKS_PERSONALIA"]);
unset($_SESSION["LOGINDEP_PERSONALIA"]);
unset($_SESSION["LOGINDIV_PERSONALIA"]);
unset($_SESSION["LOGINPTKVIEW_PERSONALIA"]);
