...
if(isset($_POST["login"]))
{
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
    {
        ...
        { 
            $_SESSION["IP_ADDRESS_PERSONALIA"]   = $IP_ADDRESS;
            $_SESSION["PC_NAME_PERSONALIA"]      = $PC_NAME;
            $_SESSION["LOGINIDUS_PERSONALIA"]    = $row["kode_user"];
            $_SESSION["LOGINNAMAUS_PERSONALIA"]  = $row["nama_user"];
            $_SESSION["LOGINAKS_PERSONALIA"]     = $row["akses"];
            $_SESSION["LOGINDEP_PERSONALIA"]     = $row["kode_departement"];
            $_SESSION["LOGINDIV_PERSONALIA"]     = $row["kode_divisi"];
            $_SESSION["LOGINPTKVIEW_PERSONALIA"] = $row["ptk_view"];
