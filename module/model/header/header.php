    ...
    <ul class="nav navbar-nav navbar-right">
        <li class="dropdown profile">
            <a href="javascript:void(0);" class="dropdown-toggle" data-toggle="dropdown" style="background-color: <?= $COL; ?> ;">
                <span class="meta">
                    <span class="text hidden-xs hidden-sm pl5"><?php echo $_SESSION["LOGINNAMAUS_PERSONALIA"]?>
                    </span>
                </span>
            </a>
            <ul class="dropdown-menu" role="menu">
                ...
                <?php if($_SESSION['LOGINAKS_PERSONALIA'] == "Administrator" or $_SESSION['LOGINAKS_PERSONALIA'] == "Recruitment"){ ?>
