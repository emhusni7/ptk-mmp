            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" required="" multiple="multiple" id="JAM_KERJA" name="JAM_KERJA[]" title="Bergantung pada Lokasi Kerja yang dipilih" data-parsley-required>
