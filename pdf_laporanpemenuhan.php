...
$result = GetQuery("select  z.*,
	...
	class PDF extends FPDF
	{
		...
		{	
			...
			$this->Image('assets/image/images/logommp.png',5,6,30);
			$this->Cell(22);
	    	$this->Write(0,"PT. MEGA MARINE PRIDE");
		    $this->Ln(1);
...
while ($row = $result->fetch(PDO::FETCH_ASSOC)) 
{
    ...
    $pdf->Cell(43,5,substr($row["nama_section"],0,37),1,0,"L");
